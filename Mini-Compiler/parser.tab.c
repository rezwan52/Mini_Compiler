...
static const char *const yytname[] =
{
  ...
  "'/'", "UMINUS", "ID", "NUMBER", "INT", "PRINT", "PLUS", "EQUALS",
  "SEMICOLON", "LPAREN", "RPAREN", "$accept", "program", "statement_list",
...
{
     -12,     4,    -3,   -12,     3,    -2,   -12,    -1,     1,     1,
     -12,   -12,   -10,   -11,     1,     0,   -12,   -12,   -12
};
...
{
      13,    14,    14,    16,     3,    17,    15,     4,     5,    10,
      11,     7,     9,     8,    18
};

static const yytype_int8 yycheck[] =
{
       9,    12,    12,    14,     0,    14,    16,    10,    11,     8,
       9,     8,    13,    15,    14
};
...
{
       0,    18,    19,     0,    10,    11,    20,     8,    15,    13,
       8,     9,    21,    21,    12,    16,    14,    21,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: INT ID EQUALS expr SEMICOLON  */
#line 64 "parser.y"
                                     { set_var_value((yyvsp[-3].str), (yyvsp[-1].num)); }
#line 1109 "parser.tab.c"
    break;

  case 6: /* statement: PRINT LPAREN expr RPAREN SEMICOLON  */
#line 65 "parser.y"
                                          { printf("%d\n", (yyvsp[-2].num)); }
...
#line 1127 "parser.tab.c"
  ...
  case 9: /* expr: ID  */
#line 71 "parser.y"
                       { (yyval.num) = get_var_value((yyvsp[0].str)); }
